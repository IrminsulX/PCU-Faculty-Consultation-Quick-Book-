...
(function () {
  ...
  // ─── Professor Catalog ─────────────────────────────
  PCU.PROFESSORS = [
    { id:'delacruz', name:'Dr. Ricardo Dela Cruz', department:'College of Business Administration', specialization:'Business Management', email:'r.delacruz@pcu.edu.ph', initials:'DC', color:'#7B1E2E', consultationHours:[{day:'Monday',start:'09:00',end:'12:00'},{day:'Wednesday',start:'13:00',end:'17:00'},{day:'Friday',start:'09:00',end:'12:00'}], bufferTime:15 },
    { id:'santos', name:'Prof. Maria Santos', department:'College of Business Administration', specialization:'Marketing', email:'m.santos@pcu.edu.ph', initials:'MS', color:'#7B1E2E', consultationHours:[{day:'Tuesday',start:'08:00',end:'12:00'},{day:'Thursday',start:'13:00',end:'17:00'}], bufferTime:10 },
    { id:'gonzales', name:'Dr. Antonio Gonzales', department:'College of Business Administration', specialization:'Finance', email:'a.gonzales@pcu.edu.ph', initials:'AG', color:'#7B1E2E', consultationHours:[{day:'Monday',start:'13:00',end:'16:00'},{day:'Wednesday',start:'09:00',end:'12:00'}], bufferTime:20 },
    ...
    { id:'fernandez', name:'Dr. Isabel Fernandez', department:'College of Nursing', specialization:'Clinical Nursing', email:'i.fernandez@pcu.edu.ph', initials:'IF', color:'#C62828', consultationHours:[{day:'Tuesday',start:'08:00',end:'15:00'},{day:'Thursday',start:'08:00',end:'15:00'}], bufferTime:20 },
